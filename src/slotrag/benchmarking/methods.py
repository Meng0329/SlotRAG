...
METHODS: dict[str, MethodSpec] = {
    ...
    "slotrag-qo-flat": MethodSpec(
        ...
        complementary_retrieval=True,
        primary_query_variant="question_plus_lexical_slot",
        description="G7: cost-only optimizer control (flat importance = budget-driven allocation, no chain-law sensitivity)",
    ),
    ...
    "slotrag-grounded-frontier-perpath-guard": MethodSpec(
        "slotrag-grounded-frontier-perpath-guard",
        "slotrag",
        options=ExecutionOptions(frontier_safe_selection=True),
        grounded_entity_anchor_substitution=True,
    ...
    "slotrag-grounded-frontier-union": MethodSpec(
        ...
        extraction_enable_thinking=True,
        structured_answer_contract=True,
        description="H-013: frontier guard + anchor protection + union extraction (no per-path)",
    ),
    "slotrag-grounded-frontier-perpath-bridge": MethodSpec(
        "slotrag-grounded-frontier-perpath-bridge",
        "slotrag",
        options=ExecutionOptions(frontier_safe_selection=True, bridge_entity_fallback=True),
        grounded_entity_anchor_substitution=True,
        role_projected_extraction=True,
        protect_known_binding_values=True,
        direct_grounded_anchor_projection=True,
