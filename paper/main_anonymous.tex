% This is the internal-sharing version of the paper with anonymization preserved.
% For the ACTUAL submission, replace \author{} with real author names and affiliations.
% IEEE TKDE uses single-anonymous review: author names ARE visible to reviewers.
...
in the earlier census. We present the system's contribution:
...
\begin{IEEEkeywords}
retrieval-augmented generation, multi-hop question answering, query processing,
physical planning, budget-aware execution, evidence planning, knowledge engineering
\end{IEEEkeywords}
